...
public interface IDevolucionRepository
{
    ...
    /// <summary>
    /// Ancla la serialización de devoluciones sobre la fila de la venta. Debe invocarse dentro de
    /// la transacción, ANTES de leer lo ya devuelto: dos peticiones concurrentes sobre la misma
    /// venta quedan en fila en este punto y la segunda ve el tope consumido por la primera, de modo
    /// que el reembolso nunca supera lo pagado (la lectura optimista sola permite duplicarlo).
    /// </summary>
